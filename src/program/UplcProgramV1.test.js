...
const dummyArg = new UplcInt(0)

describe(UplcProgramV1.name, () => {
    it("evaluates always_fails as error", () => {
        const { result } = UplcProgramV1.fromCbor(
    ...
    it("evaluates always_succeeds as non-error", () => {
        const program = UplcProgramV1.fromCbor("4e4d01000033222220051200120011")
        ...
        const term = new UplcCall(
            new UplcLambda(
                UplcCall.multi(new UplcBuiltin(0), [
                    ...
                    UplcCall.multi(new UplcVar(1), [
                        new UplcConst(new UplcInt(5)),
                        new UplcConst(new UplcInt(4))
                    ])
                ])
            ),
            new UplcLambda(
    ...
    it(`evaluates (program 1.0.0 (con bool false)) as UplcBool(false)`, () => {
        const program = UplcProgramV1.fromString(
...
const conformanceTests = [
    {
        ...
        mem: 200n,
        cpu: 23100n,
        result: new UplcBool(false)
    },
    {
        src: "(program 1.0.0 (con bool True))",
        mem: 200n,
        cpu: 23100n,
        result: new UplcBool(true)
    },
    {
        src: "(program 1.0.0 (con bytestring #00ff))",
        mem: 200n,
        cpu: 23100n,
        result: new UplcByteArray([0x00, 0xff])
    },
    {
        src: "(program 1.0.0 (con bytestring #54686543616B654973414C6965))",
        mem: 200n,
        cpu: 23100n,
        result: new UplcByteArray(hexToBytes("54686543616B654973414C6965"))
    },
    {
        src: "(program 1.0.0 (con bytestring #))",
        mem: 200n,
        cpu: 23100n,
        result: new UplcByteArray([])
    },
    {
        src: "(program 1.0.0 (con data (B #0123456789ABCDEF)))",
        mem: 200n,
        cpu: 23100n,
        result: new UplcDataValue(new ByteArrayData("0123456789ABCDEF"))
    },
    {
        src: "(program 1.0.0 (con data (Constr 1 [I 1])))",
        mem: 200n,
        cpu: 23100n,
        result: new UplcDataValue(new ConstrData(1, [new IntData(1)]))
    },
    {
        src: "(program 1.0.0 (con data (I 12354898)))",
        mem: 200n,
        cpu: 23100n,
        result: new UplcDataValue(new IntData(12354898n))
    },
    {
        src: "(program 1.0.0 (con data (List [Constr 1 [], I 1234, B #ABCDEF])))",
        mem: 200n,
        cpu: 23100n,
        result: new UplcDataValue(
            new ListData([
                new ConstrData(1, []),
                new IntData(1234),
                new ByteArrayData("ABCDEF")
            ])
        )
    },
    {
        ...
        result: new UplcDataValue(
            new MapData([
                [new ByteArrayData("0123"), new IntData(12345)],
                [new IntData(789453), new ByteArrayData("456789")],
                [
                    new ListData([new IntData(-12364689486)]),
                    new ConstrData(7, [])
                ]
            ])
        )
    },
    {
        ...
        mem: 200n,
        cpu: 23100n,
        result: new UplcInt(0)
    },
    {
        src: "(program 1.0.0 (con integer 1))",
        mem: 200n,
        cpu: 23100n,
        result: new UplcInt(1)
    },
    {
        src: "(program 1.0.0 (con integer -1))",
        mem: 200n,
    ...
    },
    {
        ...
        mem: 200n,
        cpu: 23100n,
        result: new UplcList(UplcType.int(), [])
    },
    {
        src: "(program 1.0.0 (con (pair integer bool) (12345, True)))",
        mem: 200n,
        cpu: 23100n,
        result: new UplcPair(new UplcInt(12345), new UplcBool(true))
    },
    {
        ...
        result: new UplcPair(
            new UplcInt(12345),
            new UplcPair(new UplcUnit(), new UplcBool(true))
        )
    },
    {
        ...
        mem: 200n,
        cpu: 23100n,
        result: new UplcString("")
    },
    {
        src: '(program 1.0.0 (con string "xyz"))',
        mem: 200n,
        cpu: 23100n,
        result: new UplcString("xyz")
    },
    {
        src: '(program 1.0.0 (con string "λ-calculus"))',
        mem: 200n,
        cpu: 23100n,
        result: new UplcString("λ-calculus")
    },
    {
    ...
    },
    {
        ...
        mem: 603n,
        cpu: 338095n,
        result: new UplcByteArray("#54686543616B654973414C6965")
    },
    {
        src: "(program 1.0.0 [(builtin decodeUtf8) (con bytestring #4f6c61)])",
        mem: 406n,
        cpu: 580693n,
        result: new UplcString("Ola")
    },
    {
    ...
    },
    {
        ...
        mem: 410n,
        cpu: 156086n,
        result: new UplcByteArray("4f6c61")
    },
    {
    ...
    },
    {
        ...
        mem: 432n,
        cpu: 70100n,
        result: new UplcDataValue(new IntData(0))
    },
    {
    ...
    },
    {
        ...
        mem: 732n,
        cpu: 203593n,
        result: new UplcList(UplcType.int(), [new UplcInt(0)])
    },
    {
    ...
    },
    {
        ...
        mem: 432n,
        cpu: 91658n,
        result: new UplcList(UplcType.data(), [])
    },
    {
        src: "(program 1.0.0 [(builtin mkNilPairData) (con unit ())])",
        mem: 432n,
        cpu: 85663n,
        result: new UplcList(UplcType.dataPair(), [])
    },
    {
    ...
    },
    {
        ...
        mem: 601n,
        cpu: 568560n,
        result: new UplcInt(-503)
    },
    {
        src: "(program 1.0.0 [(builtin modInteger) (con integer -503) (con integer 1777777777)])",
        mem: 601n,
        cpu: 568560n,
        result: new UplcInt(1777777274)
    },
    {
        src: "(program 1.0.0 [(builtin modInteger) (con integer 503) (con integer -1777777777)])",
        mem: 601n,
    ...
    },
    {
        ...
        mem: 602n,
        cpu: 207996n,
        result: new UplcInt(131928924380432445633603606956145n)
    },
    {
        src: "(program 1.0.0 [[(builtin multiplyInteger) (con integer 793479793478939)] (con integer -166266268485555555)])",
        mem: 602n,
    ...
    },
    {
        ...
        cpu: 23100n,
        result: new UplcPair(
            new UplcPair(new UplcBool(true), new UplcByteArray("012345")),
            new UplcList(UplcType.int(), [
                new UplcInt(0),
                new UplcInt(1),
                new UplcInt(2)
            ])
    ...
    },
    {
        ...
        mem: 601n,
        cpu: 568780n,
        result: new UplcInt(283378378503190012n)
    },
    {
        src: "(program 1.0.0 [(builtin quotientInteger) (con integer -503783783785265728700234277) (con integer 1777777777)])",
        mem: 601n,
    ...
    },
    {
        ...
        mem: 804n,
        cpu: 426418n,
        result: new UplcByteArray("43616b6549")
    },
    {
        src: "(program 1.0.0 [(builtin sliceByteString) (con integer -3) (con integer 5) (con bytestring #54686543616B654973414C6965)])",
        mem: 804n,
        cpu: 426418n,
        result: new UplcByteArray("5468654361")
    },
    {
    ...
    },
    {
        ...
        mem: 804n,
        cpu: 426418n,
        result: new UplcByteArray("6b6549")
    },
    {
...
describe(`${UplcProgramV1.name} conformance`, () => {
    ...
    runtimeErrorTests.forEach((s) => {
        it(`fails to run ${s}`, () => {
            const program = UplcProgramV1.fromString(s)
